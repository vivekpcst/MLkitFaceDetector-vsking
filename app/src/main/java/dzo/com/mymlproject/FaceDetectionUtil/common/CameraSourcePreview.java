...
package dzo.com.mymlproject.FaceDetectionUtil.common;
...
public class CameraSourcePreview extends ViewGroup {
      ...
      if (ContextCompat.checkSelfPermission(context, CAMERA_PERMISSION)
        ...
        if (showRequestPopup) {
          if (currentFragment != null) {
            currentFragment.requestPermissions(new String[]{CAMERA_PERMISSION}, FaceDetectionScanner.Constants.PERMISSION_REQUEST_CAMERA);
          } else
            ActivityCompat.requestPermissions((Activity) context,
                    new String[]{CAMERA_PERMISSION}, FaceDetectionScanner.Constants.PERMISSION_REQUEST_CAMERA);
        }
        return false;
      }
    } else {
  ...
  public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
    if (requestCode == FaceDetectionScanner.Constants.PERMISSION_REQUEST_CAMERA && grantResults.length > 0)
