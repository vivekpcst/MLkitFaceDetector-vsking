...
import dzo.com.mymlproject.FaceCenterCircleView.FaceCenterCrop.FaceCenterCropListener;
import dzo.com.mymlproject.FaceDetectionUtil.common.CameraSource;
import dzo.com.mymlproject.FaceDetectionUtil.common.CameraSourcePreview;
...
import dzo.com.mymlproject.Utils.FaceDetectionScanner;
...
public class ScannerActivity extends AppCompatActivity {
    ...
    private void startCameraSource() {
        ...
        if (code != ConnectionResult.SUCCESS) {
            Dialog dlg =
                    GoogleApiAvailability.getInstance().getErrorDialog(this, code, FaceDetectionScanner.Constants.PERMISSION_REQUEST_CAMERA);
            dlg.show();
        }
